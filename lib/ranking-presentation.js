...
export const UI_SCALE_KEYS = Object.freeze(['overall', 'card', 'rail', 'annotation', 'controls']);
...
export function createRankingPresentation({ read, write }) {
  ...
  try {
    ...
    if (parsed !== null && typeof parsed === 'object' && !Array.isArray(parsed)) {
      ...
      if (parsed.showTitles === false) showTitles = false;
  ...
  function persist() {
    try {
      write(RANKING_UI_KEY, JSON.stringify({
        showCounts,
        showTitles,
