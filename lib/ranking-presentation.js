...
export function createImmersiveController({ root, documentRef, idleMs = 3000, onBeforeChange = () => {}, onChange = () => {} }) {
  ...
  documentRef.addEventListener('keydown', event => {
    ...
    if (controls.hidden === false) { event.preventDefault?.(); hideControls(true); toggle?.focus?.(); }
    // Return to editing is explicit. Esc belongs to overlays and browser fullscreen.
  });
