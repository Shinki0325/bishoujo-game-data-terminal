...
export function projectWorkbenchControls({
  ...
  showCounts, showTitles
    ...
    controls.clearCandidates.disabled = importBusy || activeRankingState.unrankedCount === 0;
    ...
    controls.mobileRankingExportQuick.disabled = controls.exportPng.disabled;
    controls.mobileRankingExportQuick['aria-busy'] = String(pngExportInProgress);
