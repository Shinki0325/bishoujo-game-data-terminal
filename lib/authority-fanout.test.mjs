...
import { applyAuthorityFanoutMediaToWork, prepareAuthorityFanoutMediaProjection, prepareAuthorityFanoutPageBindings, prepareAuthorityFanoutProjection } from './authority-fanout.js';
...
const mediaProjection = prepareAuthorityFanoutMediaProjection(value, { catalogSnapshotId: 'fixture', catalogSha256: sha, workIds: ['84'] });
const pageBindingProjection = prepareAuthorityFanoutPageBindings(value, { catalogSnapshotId: 'fixture', catalogSha256: sha, workIds: ['84'], ratingsSha256: sha });
...
assert.equal(mediaProjection.selectedMediaByWorkId.size, 1);
assert.equal(pageBindingProjection.pageBindingIssues.length, 0);
assert.throws(() => prepareAuthorityFanoutMediaProjection({ ...value, mediaSelections: [] }, { catalogSnapshotId: 'fixture', catalogSha256: sha, workIds: ['84'] }));
