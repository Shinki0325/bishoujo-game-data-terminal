...
test('default preload retries a transient manifest failure and dedupes concurrent startup',async()=>{
...
test('transient speculative first page failure retries without reloading bootstrap',async()=>{
