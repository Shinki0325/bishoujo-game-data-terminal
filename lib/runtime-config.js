...
export const M2_PERSON_CROSS_SOURCE_CROSSWALK_SHA256 = 'f5fa141c00af3c3a4a64e2eae64ee20a0c2f5cf895d589419b430e5f3a628e30';
...
export const RUNTIME_FEATURES = Object.freeze({
  ...
  personDirectoryV1: Object.freeze({ enabled: true })
});
...
export const DATA_URLS = Object.freeze({
  ...
  m2PersonManifest: versionedDataUrl('terminal-wiki-m2-person-source-only-v1/canonical-manifest.json'),
  m2PersonEntities: versionedDataUrl('terminal-wiki-m2-person-source-only-v1/entities.json'),
  m2PersonRelations: versionedDataUrl('terminal-wiki-m2-person-source-only-v1/relations.json'),
  m2PersonNameVariants: versionedDataUrl('terminal-wiki-m2-person-source-only-v1/name-variants.json'),
  m2PersonCharacterRoles: versionedDataUrl('terminal-wiki-m2-person-source-only-v1/character-roles.json'),
  m2PersonNamePreferences: versionedDataUrl('terminal-wiki-m2-person-source-only-v1/name-preferences.json'),
  m2PersonCrossSourceCrosswalk: versionedDataUrl('terminal-wiki-m2-person-source-only-v1/cross-source-crosswalk.json'),
  m1PersonEntities: versionedDataUrl('terminal-wiki-m1-person-source-only-v1/entities.json'),
  m1PersonVoiceRelations: versionedDataUrl('terminal-wiki-m1-person-source-only-v1/voice-relations.json')
});
