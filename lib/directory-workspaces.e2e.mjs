...
try {
 ...
 if(activePage&&!activePage.isClosed()){
  ...
  await activePage.screenshot({path:'D:/blog-kb/reports/directory-workspaces-failure-20260907.png'});
 }
}
finally{await browser.close();await new Promise(done=>server.close(done));}
await writeFile('D:/blog-kb/reports/directory-workspaces-e2e-20260907.json',JSON.stringify(report,null,2));
