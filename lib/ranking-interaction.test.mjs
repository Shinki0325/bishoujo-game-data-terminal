...
import {createRankingExportController} from './ranking-export-controller.js';
...
test('export geometry preview uses the clicked snapshot without starting a PNG job',async()=>{
  ...
  assert.deepEqual(await controller.preview(),{rankedCount:1,width:296,height:864,columns:1});assert.equal(controller.busy,false);assert.equal(planned,1);
});
