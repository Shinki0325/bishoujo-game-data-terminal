...
assert.match(mainSource, /const initialProjection = projectEntityRuntime\?\.projectCredits\?\.\(scopedCredits\);/u);
assert.match(mainSource, /workDetailCreditsLoader\.loadCharacterImages\(work\.workId\)/u);
