...
import {createWorkbenchUISummary} from './workbench-ui-summary.js';
...
export function createWorkbenchWorkerHandler({runtime,loadSource,projectWork,onData}) {
  ...
  return async message=>{
    ...
    try {
      ...
      if(data&&onData)onData({id:message.id,type:'workbench-data',manifestSha256:source.sha256,workbenchBytes:bundle.bytes,uiSummary});
      ...
      window=nextWindow;
      return data&&!onData?{...result,manifestSha256:source.sha256,workbenchBytes:bundle.bytes,uiSummary}:result;
