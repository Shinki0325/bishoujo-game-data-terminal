...
test('real full-catalog IDs, sort order, aliases and conditional histograms remain equal',()=>{
 ...
 const a=createQueryIndex({...options,works:full}),b=createQueryIndex({...options,works:candidate.ratedDisplayWorks.map(workbenchQueryWork),searchText:candidate.searchText});
