...
assert.deepEqual(egsCreator?.roleHints, []);
assert.equal(egsCreator?.credits.some(credit => credit.creditType === 'character-voiced-by'), true);
assert.equal(egsCreator?.credits.length > 0, true);
