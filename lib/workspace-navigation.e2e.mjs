...
const preview = source.replace(
  '<script type="module" src="./releases/20260904-person-performance-final-v7/main.js"></script>',
  '<script type="module" src="./main.js"></script>'
);
assert.notEqual(preview, source, 'preview entry must load the candidate main.js');
