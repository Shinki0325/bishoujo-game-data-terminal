...
const immutableAuthorityFanoutUrl = new URL(
  '../data/egs-tier-authority-fanout-v1.20260823-immutable-fanout-v1.json',
  import.meta.url
);
...
export const DATA_URLS = Object.freeze({
  ...
  authorityFanout: immutableAuthorityFanoutUrl,
