...
import {
  ...
  DATA_REVISION
} from './lib/runtime-config.20260824-bangumi-ratings-v1.js?v=0ab5333739a11d864a5167e10af3010d34e43668c548dfb580a522461f6c2edd';
...
function showDetails(work, filterById, workAliasesById = null, onOpenCompany = null, projectEntityRuntime = null, detailMedia = null) {
  ...
  if (work.bangumiRating !== undefined) {
    ...
    const snapshot = document.createElement('small');
    snapshot.className = 'details-rating-snapshot';
    snapshot.textContent = `Bangumi 数据快照时间：${work.bangumiRating.retrievedAt ?? '未返回'}`;
