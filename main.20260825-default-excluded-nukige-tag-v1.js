...
import { createAppController } from './lib/app-controller.20260825-default-excluded-nukige-tag-v1.js';
...
import {
  ...
  DATA_REVISION
} from './lib/runtime-config.20260825-cross-source-admissions-bangumi-title-variants-v1.js?v=99865175b5dc69e4d87fbf431085175a7c7281fb810bbd17d38a207bedfa780f';
import { selectionStateForResults } from './lib/selection.js';
import { StateValidationError, USER_WORK_LIMIT } from './lib/state.js?v=20260825-default-excluded-nukige-tag-v1';
  ...
  if (vndbRatingsSource !== null) {
    try {
      ...
      vndbRatings = prepareVndbRatingsSidecar(vndbRatingsSource.value, {
        catalogSnapshotId: sampleSource.snapshot?.snapshotId,
        catalogSha256: catalogSource.sha256,
        workIds: sampleSource.works.map(work => work.workId)
      });
    } catch (error) {
