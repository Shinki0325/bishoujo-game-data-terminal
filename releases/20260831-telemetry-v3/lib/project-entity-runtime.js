...
export async function createProjectEntityRuntime({ bridge, catalog, dataRevision, cryptoRef = globalThis.crypto } = {}) {
  ...
  return Object.freeze({
    ...
    projection,
    detailProjection,
    personCharacterProjection: buildPersonCharacterProjections([]),
    ...
    projectCredits(credits) {
      ...
      return Object.freeze({
        ...
        adaptCharacter: (characterEntityId, legacy = {}) => adaptCharacterPageVM({ characterEntityId, legacy, projection: { records: projections.characters }, featureFlags: { characterPageV1: true } }),
      });
    },
