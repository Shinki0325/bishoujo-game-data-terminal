...
export function createCompanyDirectoryView({
  ...
  function render({
    ...
    detailMeta.textContent = `${selected.workCount} 部作品 · ${companyReleaseSpan(selected, selectedWorks)} · 评分人数合计 ${formatCount(selected.totalVoteCount)} · 每版本平均 ${formatCount(selected.averageVoteCount)}`;
