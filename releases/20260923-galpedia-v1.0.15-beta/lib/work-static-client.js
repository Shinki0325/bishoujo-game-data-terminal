...
function createLocalStaticWorkQueryClient({data,workerFactory,count,sourceSha256,listData=null,prepareCards=null,includeWorkCards=false}) {
  ...
  return Object.freeze({
    ...
    async query(input,{onProgress=()=>{}}={}){
      alive();nextCards=null;const ticket=++sequence;const defaults=input.analysisWorkIds===undefined&&!disabled&&input.paged&&!input.includeProjectedCounts?await data.defaults():null;
