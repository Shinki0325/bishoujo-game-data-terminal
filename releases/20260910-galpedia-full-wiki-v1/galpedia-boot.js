import { preloadWorkbenchModules } from './lib/workbench-startup-hints.js';
...
let landing;
let personLanding;
function finishLanding() { landing?.dispose();landing=null;personLanding?.dispose();personLanding=null; }
...
async function ensureRoute() {
  ...
  if (root.dataset.personDirectory === 'full-wiki' && /^#persons(?:[/?]|$)/u.test(hash)) return ensureRuntime();
