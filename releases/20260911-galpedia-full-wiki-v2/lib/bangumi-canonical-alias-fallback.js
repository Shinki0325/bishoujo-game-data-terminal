...
export function prepareBangumiCanonicalAliasFallback(sidecar, {
  ...
  if (sidecar.sourceBangumiPublicBindingsSha256 !== bangumiPublicBindingsSha256) {
    throw new TypeError('Bangumi canonical alias fallback binding authority does not match');
  }
  ...
  assertSha256(sidecar.sourceBangumiPublicBindingsSha256, 'sourceBangumiPublicBindingsSha256');
